...
CK_OBJECT_HANDLE_LENGTH = _LowLevel.CK_OBJECT_HANDLE_LENGTH
...
class CK_AES_CTR_PARAMS(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    ulCounterBits = property(_LowLevel.CK_AES_CTR_PARAMS_ulCounterBits_get, _LowLevel.CK_AES_CTR_PARAMS_ulCounterBits_set)
    cb = property(_LowLevel.CK_AES_CTR_PARAMS_cb_get, _LowLevel.CK_AES_CTR_PARAMS_cb_set)

    def __init__(self):
        _LowLevel.CK_AES_CTR_PARAMS_swiginit(self, _LowLevel.new_CK_AES_CTR_PARAMS())
    __swig_destroy__ = _LowLevel.delete_CK_AES_CTR_PARAMS

# Register CK_AES_CTR_PARAMS in _LowLevel:
_LowLevel.CK_AES_CTR_PARAMS_swigregister(CK_AES_CTR_PARAMS)
CK_AES_CTR_PARAMS_LENGTH = _LowLevel.CK_AES_CTR_PARAMS_LENGTH
...
class CK_KEY_DERIVATION_STRING_DATA(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    pData = property(_LowLevel.CK_KEY_DERIVATION_STRING_DATA_pData_get, _LowLevel.CK_KEY_DERIVATION_STRING_DATA_pData_set)
    ulLen = property(_LowLevel.CK_KEY_DERIVATION_STRING_DATA_ulLen_get, _LowLevel.CK_KEY_DERIVATION_STRING_DATA_ulLen_set)

    def __init__(self):
        _LowLevel.CK_KEY_DERIVATION_STRING_DATA_swiginit(self, _LowLevel.new_CK_KEY_DERIVATION_STRING_DATA())
    __swig_destroy__ = _LowLevel.delete_CK_KEY_DERIVATION_STRING_DATA

# Register CK_KEY_DERIVATION_STRING_DATA in _LowLevel:
_LowLevel.CK_KEY_DERIVATION_STRING_DATA_swigregister(CK_KEY_DERIVATION_STRING_DATA)
CK_KEY_DERIVATION_STRING_DATA_LENGTH = _LowLevel.CK_KEY_DERIVATION_STRING_DATA_LENGTH
...
class CPKCS11Lib(object):
    ...
    def Duplicate(self, ref):
        return _LowLevel.CPKCS11Lib_Duplicate(self, ref)
